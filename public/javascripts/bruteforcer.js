     ...
     all.forEach(function(entry,i,a) {
        ...
        var x = r.split(".");
                    ...
                    if(all.length<50){
                     ...
                     gpx = gpx + "<wpt lat=\"" + decLat + "\" lon=\"" + decLon + "\">"+
                            "<time>2013-05-09T00:00:00</time>"+
                            "<name>possible cache location " + count + "</name>"+
                            "<desc>possible cache " + count + "</desc>"+
                            "<sym>Geocache</sym>"+
      ...
      document.getElementById("gpx").href = "data:text/xml;charset=utf-8," + escape(gpx_details + gpx +"</gpx>");
}
